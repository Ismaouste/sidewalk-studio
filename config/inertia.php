...
return [
    ...
    */
    ...
    'devtools' => [
        ...
        // Opt-in rather than auto-on in local: when left unset it injects a
        // payload script into every response, which the static preview export
        // then bakes into the generated HTML.
