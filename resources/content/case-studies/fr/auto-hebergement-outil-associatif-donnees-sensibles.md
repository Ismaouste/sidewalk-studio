...
accent_tone: coral
client: Aremedia
role: Cadrage technique, implémentation, hébergement et documentation
stack:
    - Open Survey
    - PHP
    - Auto-hébergement
    ...
    - Markdown
outcomes:
    - Clarifier les choix d'hébergement et de sécurité
    - Adapter l'outil à des usages de terrain
