...
offers:
    ...
    - label: Abonnement
      title: Signal
      summary: De l'ingénierie growth en continu — les flux, les campagnes et les mesures qui gardent une boutique visible, avec un rapport mensuel sur lequel on peut agir.
      price: à partir de 900 € / mois
      price_meta: mensuel, sans engagement
      points:
          - Synchronisation des catalogues et publicités dynamiques maintenues sur toutes les plateformes.
          - Données structurées et SEO technique entretenus, pas seulement installés.
          - Rapports Core Web Vitals et recherche, en langage clair.
      cta: Garder le cap
      tone: coral
    - label: TJM
      ...
      points:
          - Des décisions d'architecture et de stack argumentées par écrit.
          - De la livraison concrète à côté de la direction, pas à sa place.
          - Recrutement, revue de code et dette technique rendus lisibles pour le métier.
      cta: Parler direction
      tone: sun
    - label: Forfait cadré
...
engagement:
    ...
    steps:
        - title: Un premier échange qui ne coûte rien
          summary: Trente minutes sur le contexte, la contrainte, et la question de savoir si je suis la bonne personne. Si ce n'est pas le cas, je le dis et j'oriente vers quelque chose d'utile.
...
contact_cta:
    title: La prochaine étape tient en un court message.
    summary: 'Dites quel type de projet c''est, à peu près pour quand, et ce que ça doit changer : le formulaire de contact pose exactement ces trois questions.'
---
