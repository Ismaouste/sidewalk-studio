...
const form = useForm({
    original_publication_type:
        props.publication.original_publication_type ??
        props.publication.publication_type,
    original_locale:
        props.publication.original_locale ?? props.publication.locale,
...
const submitLabel = computed(() =>
    form.processing ? 'Saving…' : 'Save publication',
);
        ...
        <form class="admin-publication" @submit.prevent="submit">
            <header class="admin-publication__header">
                <div>
                    ...
                    <h1 class="type-h1 admin-publication__title">
                        {{
                            mode === 'create'
                    ...
                    <p class="type-body admin-publication__copy">
                        File-backed legacy entries become database-managed as
                        soon as they are saved here. Metadata lives in the
                        database. The long-form body stays in the linked
                        markdown file.
                    </p>
                </div>
            ...
            <div class="admin-publication__grid">
                <Panel class="admin-publication__panel" tone="elevated">
                    ...
                    <label class="admin-publication__field">
                        ...
                        <select
                            ...
                            class="admin-publication__input"
                        >
                    ...
                    <label class="admin-publication__field">
                        ...
                        <textarea
                            ...
                            class="admin-publication__input admin-publication__input--textarea"
                            rows="4"
                        />
                    </label>
                </Panel>
                ...
                <Panel class="admin-publication__panel" tone="surface">
                    ...
                    <div
                        v-for="(_, index) in form.tags"
                        :key="`tag-${index}`"
                        class="admin-publication__row"
                    >
                        <input
                ...
                <Panel class="admin-publication__panel" tone="grid">
                    ...
                    <div class="admin-publication__panel-head">
                        ...
                        <button
                            class="admin-publication__mini"
                            type="button"
                            @click="addMetadataItem('stack')"
                        >
                            Add stack item
                        </button>
                    </div>
                    <div
                        v-for="(_, index) in form.metadata.stack"
                        :key="`stack-${index}`"
                        class="admin-publication__row"
                    >
                        <input
                            v-model="form.metadata.stack[index]"
                            class="admin-publication__input"
                            type="text"
                        />
                    </div>
                    <div class="admin-publication__panel-head">
                        ...
                        <button
                            class="admin-publication__mini"
                            type="button"
                            @click="addMetadataItem('outcomes')"
                        >
                            Add outcome
                        </button>
                    </div>
                    <div
                        v-for="(_, index) in form.metadata.outcomes"
                        :key="`outcome-${index}`"
                        class="admin-publication__row"
                    >
                        <input
                            v-model="form.metadata.outcomes[index]"
                            class="admin-publication__input"
                            type="text"
                        />
                    </div>
                ...
                <Panel
                    class="admin-publication__panel admin-publication__panel--full"
                    tone="elevated"
                >
                    <div class="admin-publication__markdown-grid">
                        <label class="admin-publication__field">
                            ...
                            <textarea
                                ...
                                class="admin-publication__input admin-publication__input--editor"
                                rows="20"
                            />
                        </label>
                        <div class="admin-publication__preview">
                            ...
                            <QuoteLinePreview
                                ...
                                compact
                            />
                            <pre class="admin-publication__preview-body">{{
                                form.body_markdown
                            }}</pre>
                        </div>
                    </div>
