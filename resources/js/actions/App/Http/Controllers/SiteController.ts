...
* @see app/Http/Controllers/SiteController.php:213
...
* @see app/Http/Controllers/SiteController.php:184
...
* @see app/Http/Controllers/SiteController.php:149
* @route '/{locale}/local'
*/
...
* @see app/Http/Controllers/SiteController.php:300
* @route '/{locale}/labs'
*/
...
* @see app/Http/Controllers/SiteController.php:326
...
* @see app/Http/Controllers/SiteController.php:355
...
* @see app/Http/Controllers/SiteController.php:380
...
* @see app/Http/Controllers/SiteController.php:398
* @route '/cv/{locale}'
*/
...
const SiteController = { home, experience, projectsLegacy, sparkle, local, labs, contact, dataProcessing, colophon, downloadCv }
